                ...
                <div class="tab-content" id="fuelTabsContent">
                    <div class="tab-pane fade show active" id="tanks" role="tabpanel">
                        <?php if ($storage_tanks): ?>
                            <div class="table-responsive"><table class="table table-sm table-bordered align-middle mb-0"><thead><tr><th>Branch</th><th>Tank #</th><th>Capacity</th><th>Current Level</th><th>Status</th></tr></thead><tbody>
                    ...
                    <div class="tab-pane fade" id="dispensers" role="tabpanel">
                        <?php if ($dispensers): ?>
                            <div class="table-responsive"><table class="table table-sm table-bordered align-middle mb-0"><thead><tr><th>Branch</th><th>Dispenser #</th><th>Tank #</th><th>Pump Price</th><th>Status</th></tr></thead><tbody>
                    ...
                    <div class="tab-pane fade" id="purchases" role="tabpanel">
                        <?php if ($purchases): ?>
                            <div class="table-responsive"><table class="table table-sm table-bordered align-middle mb-0"><thead><tr><th>Date</th><th>Branch</th><th>Supplier</th><th>Quantity</th><th>Unit Cost</th><th>Total Cost</th><th>Status</th></tr></thead><tbody>
                    ...
                    <div class="tab-pane fade" id="sales" role="tabpanel">
                        <?php if ($sales): ?>
                            <div class="table-responsive"><table class="table table-sm table-bordered align-middle mb-0"><thead><tr><th>Date</th><th>Time</th><th>Branch</th><th>Dispenser #</th><th>Quantity</th><th>Unit Price</th><th>Final Amount</th><th>Payment</th></tr></thead><tbody>
                    ...
                    <div class="tab-pane fade" id="price" role="tabpanel">
                        <?php if ($price_history): ?>
                            <div class="table-responsive"><table class="table table-sm table-bordered align-middle mb-0"><thead><tr><th>Branch</th><th>Old Price</th><th>New Price</th><th>Effective Date</th><th>Changed By</th><th>Reason</th></tr></thead><tbody>
                    ...
                    <div class="tab-pane fade" id="quality" role="tabpanel">
                        <?php if ($quality_tests): ?>
                            <div class="table-responsive"><table class="table table-sm table-bordered align-middle mb-0"><thead><tr><th>Date</th><th>Branch</th><th>Tank #</th><th>Type</th><th>Density</th><th>Octane</th><th>Result</th><th>Tested By</th></tr></thead><tbody>
                    ...
                    <div class="tab-pane fade" id="variance" role="tabpanel">
                        <?php if ($variances): ?>
                            <div class="table-responsive"><table class="table table-sm table-bordered align-middle mb-0"><thead><tr><th>Date</th><th>Branch</th><th>Tank #</th><th>Expected Qty</th><th>Actual Qty</th><th>Variance</th><th>Type</th><th>Reason</th><th>Status</th></tr></thead><tbody>
