            ...
            <div class="mb-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4"><strong>Total Expenses:</strong> <?php echo h(number_format($summary['total'], 2)); ?></div>
                            <div class="col-md-4"><strong>Number of Expenses:</strong> <?php echo h($summary['count']); ?></div>
                            <div class="col-md-4">
